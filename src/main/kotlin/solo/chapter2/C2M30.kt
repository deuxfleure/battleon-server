...
object C2M30 : SoloMissionDefinition {

    override val id: String = "c2_m30"
    ...
    override fun buildCampaignConfig(
        ...
        return SoloMissionGameConfig(
            ...
            opponentNameKey = "opponent.c2_m30.normal",
            ...
            shopDefinition = SoloShopDefinition(
                slots = listOf(
                    ...
                    FixedShopCard(CardId.EMPOISONNEUSE),
    ...
    override fun buildHardConfig(
        ...
        return buildCampaignConfig(
            ...
            opponentNameKey = "opponent.c2_m30.hard"
        )
    }
}