...
object C1M06 : SoloMissionDefinition {

    override val id: String = "c1_m06"
    ...
    override fun buildCampaignConfig(
        ...
        return SoloMissionGameConfig(
            ...
            opponentNameKey = "opponent.c1_m06.council_guards",
    ...
    override fun buildHardConfig(
        ...
        return buildCampaignConfig(
            ...
            opponentNameKey = "opponent.c1_m06.council_guards_hard"
        )
    }
}