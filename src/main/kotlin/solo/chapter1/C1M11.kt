...
object C1M11 : SoloMissionDefinition {

    override val id: String = "c1_m11"
    ...
    override fun buildCampaignConfig(
        ...
        return SoloMissionGameConfig(
            ...
            opponentNameKey = "opponent.c1_m11.assassins",
    ...
    override fun buildHardConfig(
        ...
        return buildCampaignConfig(
            ...
            opponentNameKey = "opponent.c1_m11.assassins_hard"
        )
    }
}